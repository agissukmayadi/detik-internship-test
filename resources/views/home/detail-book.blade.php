...
@section('content-home')
    <section class="w-full py-10 bg-gray-100">
        <div class="container mx-auto px-4  sm:px-10 md:px-40 ">
            <div class="flex flex-col sm:flex-row sm:items-start gap-5 border bg-white p-4 rounded-md  shadow-md w-full ">
