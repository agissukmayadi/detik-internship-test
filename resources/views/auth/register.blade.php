...
@section('form')
    <form action="{{ route('register.action') }}" method="POST" class="space-y-3 mt-3">
        ...
        <button
            class="w-full bg-blue-500 hover:bg-blue-600 transition-all text-white font-semibold py-2 px-4 rounded">Register</button>
        <div class="text-center">
            <span class=" text-blue-500 text-xs">Already have an account? <a href="{{ route('login') }}"
