...
@section('content-admin')
    <div class="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <a href="{{ route('admin.book.export') }}"
            class="text-sm sm:order-2 text-center px-4 py-2 bg-yellow-300 hover:bg-yellow-400 text-white font-semibold rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-opacity-75"><i
                class="fa-solid fa-file-pdf"></i> Export</a>
    ...
    <form class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4"
        method="GET" action="{{ route('admin.book') }}">
                ...
                @foreach ($books as $book)
                    <tr
                        ...
                        <td class="flex items-center px-6 py-4 gap-3">
                            <a href="{{ route('admin.book.show', $book->slug) }}"
                            ...
                            <a href="{{ route('admin.book.destroy', $book->slug) }}"
