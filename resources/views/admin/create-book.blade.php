...
@section('content-admin')
    <form class="w-full" method="POST" action="{{ route('admin.book.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="mb-5">
        ...
        <div class="mb-5">
            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file">Book File</label>
            <input
                class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                aria-describedby="file_help" id="file" type="file" name="file" accept="application/pdf" required>
        ...
        <div class="mb-5">
            ...
            <input
                class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                aria-describedby="image_help" id="image" type="file" name="image" accept="image/*" required>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="image_help">JPG, JPEG, PNG (MAX. 2MB)</p>
            @error('image')
                <small class="text-red-500 ml-2">{{ $message }}</small>
            @enderror
        </div>
