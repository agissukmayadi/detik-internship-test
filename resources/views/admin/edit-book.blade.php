...
@section('content-admin')
    <form class="w-full" method="POST" action="{{ route('admin.book.update', $book->slug) }}" enctype="multipart/form-data">
        @csrf
        <div class="mb-5">
            ...
            <div class="flex items-center gap-4">
                <div class="grow">
                    ...
                    <input
                        ...
                        aria-describedby="file_help" id="file" type="file" name="file" accept="application/pdf">
